...
| H4 | P1 | 검수 SLA 지표(최장 대기·평균 처리·반려율·사유 분포) | 대시보드는 pending 건수만 `staff/views/__init__.py:152-186` | 제품 권고. 재오픈 후 기산점은 트랙 21에서 확정(`docs/BE/draft-review-lifecycle.md` (c)). **구현 완료(2026-09-08, 트랙 22, PR 번호는 오픈 후 기입)** — 정본 `docs/BE/draft-review-lifecycle.md` (i)~(k). 사유 분포는 H10 뒤로 이연, 증감 없음(★2) |
