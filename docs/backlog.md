...
| 항목 | 값 |
|---|---|
| 백엔드 회귀 | `[실측 2026-09-09]` `uv run pytest -q` → **2488 passed**(88.79초, PR #348 머지 후 main) |
...
- H2 — 체크박스 열 + bulkbar(`templates/core/drafts/list.html:50-61`) + 행별 실패
  ...
  엔드포인트, 행 배지·인라인 버튼도 **구현 완료(트랙 25, PR #___,
