...
- H2 — 체크박스 열 + bulkbar(`templates/core/drafts/list.html:50-61`) + 행별 실패
  ...
  (2026-09-09, 트랙 24, PR #350)** — 정본 `docs/BE/staff-event-bulk-unpublish.md`.
