...
def _demo_events():
    ...
    return [
        ...
        },
        {
            ...
            "summary": "데모용 D+2 마감 팝업스토어 행사입니다.",
            "view_count": 65,
            "publish_status": Event.PublishStatus.PUBLISHED,
        },
        {
            ...
            "summary": "데모용 D+3 마감 콜라보 카페 행사입니다.",
            "view_count": 58,
            "publish_status": Event.PublishStatus.PUBLISHED,
        },
        {
            ...
            "start_date": today - timedelta(days=3),
            "end_date": today + timedelta(days=5),
            "summary": "데모용 D+5 마감 굿즈 예약 행사입니다.",
            "view_count": 48,
            "publish_status": Event.PublishStatus.PUBLISHED,
        },
