"""Auth form field errors are wired to their input via aria-describedby
(a11y re-review 2026-07-11 — PR-9). Reuses the existing signup-rejection
POST from test_signup_terms_agreement.py to actually trigger a field error
rather than asserting against static markup.
"""
import pytest
